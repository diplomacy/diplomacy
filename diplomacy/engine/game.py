    ...
    def set_phase_data(self, phase_data, clear_history=True):
        """ Set game from phase data.
            :param phase_data: either a GamePhaseData or a list of GamePhaseData.
                If phase_data is a GamePhaseData,
                it will be treated as a list of GamePhaseData with 1 element.
        ...
        # In following code, we use Game.method instead of self.method to make sure
        ...
        if clear_history:
            ...
            # Clear orders and vote.
            # Messages will be totally overwritten below.
