...
Namespace(input='src/diplomacy/maps/svg/pure.svg', name='SvgPure', output='src/gui/maps/pure/')
**/
    ...
    render() {
        ...
        return (
            <svg className="SvgPure" height="500px" preserveAspectRatio="xMinYMin" textRendering="optimizeLegibility" viewBox="0 0 1000 1000" width="500px" xmlns="http://www.w3.org/2000/svg">
                ...
                <text className={classes['CurrentPhase']} id="CurrentPhase" x="845" y="970">{current_phase}</text>
