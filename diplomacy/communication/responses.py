...
class ComplexDataGameSchedule(_AbstractResponse):
    """ Response with info about current scheduling for a game. Properties:
    ...
    def __init__(self, **kwargs):
        ...
        super(ComplexDataGameSchedule, self).__init__(**kwargs)

class ComplexDataGameInfo(_AbstractResponse):
    """ Response containing information about a game,
    to be used when no entire game object is required. Properties:
    ...
    def __init__(self, **kwargs):
        ...
        super(ComplexDataGameInfo, self).__init__(**kwargs)

class ComplexDataPossibleOrders(_AbstractResponse):
    ...
    def __init__(self, **kwargs):
        ...
        super(ComplexDataPossibleOrders, self).__init__(**kwargs)
...
class DataGames(UniqueData):
    """ Unique data containing a list of :class:`.ComplexDataGameInfo` objects. """
    __slots__ = []
    params = {
        # list of game info.
        strings.DATA: parsing.SequenceType(parsing.JsonableClassType(ComplexDataGameInfo))
    }
